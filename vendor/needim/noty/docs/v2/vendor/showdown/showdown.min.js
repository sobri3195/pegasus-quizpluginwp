...
(function () {
  ...
  function b(a, b) {
    ...
    for (var f = 0; f < a.length; ++f) {
      ...
      if ("object" != typeof h)
        return (
          (e.valid = !1),
          (e.error = g + "must be an object, but " + typeof h + " given"),
          e
        );
      if (!d.helper.isString(h.type))
        return (
          (e.valid = !1),
          (e.error =
            g +
      ...
      if ("listener" === i) {
        if (d.helper.isUndefined(h.listeners))
          return (
            (e.valid = !1),
            (e.error =
              g +
        ...
        d.helper.isUndefined(h.filter) &&
        d.helper.isUndefined(h.regex)
      )
        return (
          (e.valid = !1),
          (e.error =
      ...
      if (h.filter) {
        ...
        if (
          (d.helper.isString(h.regex) && (h.regex = new RegExp(h.regex, "g")),
        ...
        if (d.helper.isUndefined(h.replace))
          return (
            (e.valid = !1),
            (e.error =
              g +
  ...
  (d.helper = {}),
    ...
    (d.helper.forEach = function (a, b) {
      ...
      else for (var c = 0; c < a.length; c++) b(a[c], c, a);
    }),
    ...
    (d.helper.escapeCharactersCallback = c),
    (d.helper.escapeCharacters = function (a, b, d) {
      "use strict";
      var e = "([" + b.replace(/([\[\]\\])/g, "\\$1") + "])";
      d && (e = "\\\\" + e);
  ...
  (d.helper.matchRecursiveRegExp = function (a, b, c, d) {
    "use strict";
    for (var e = i(a, b, c, d), f = [], g = 0; g < e.length; ++g)
      f.push([
      ...
      if (k > 0) {
        ...
        for (var m = 0; k > m; ++m)
          l.push(
            ...
            k - 1 > m &&
              l.push(a.slice(h[m].wholeMatch.end, h[m + 1].wholeMatch.start));
        h[k - 1].wholeMatch.end < a.length &&
          l.push(a.slice(h[k - 1].wholeMatch.end)),
          (j = l.join(""));
      }
      return j;
    }),
    d.helper.isUndefined(console) &&
      (console = {
        warn: function (a) {
          "use strict";
          alert(a);
    ...
    (d.Converter = function (a) {
      ...
      function e(a, c) {
        if (((c = c || null), d.helper.isString(a))) {
          if (((a = d.helper.stdExtName(a)), (c = a), d.extensions[a]))
            return (
              console.warn(
                "DEPRECATION WARNING: " +
                  a +
              ...
              void i(d.extensions[a], a)
            );
          if (d.helper.isUndefined(f[a]))
            throw Error(
              'Extension "' +
                a +
        ...
        for (var g = 0; g < a.length; ++g) {
          ...
          if (a[g].hasOwnProperty("listeners"))
            for (var h in a[g].listeners)
              a[g].listeners.hasOwnProperty(h) && j(h, a[g].listeners[h]);
        }
      }
      function i(a, c) {
        "function" == typeof a && (a = a(new d.Converter())),
          d.helper.isArray(a) || (a = [a]);
        var e = b(a, c);
        if (!e.valid) throw Error(e.error);
        for (var f = 0; f < a.length; ++f)
      ...
      c(),
        ...
        (this.makeHtml = function (a) {
          ...
          return (
            ...
            (a = a.replace(/\r/g, "\n")),
            (a = a.replace(/\u00A0/g, " ")),
            l.smartIndentationFix && (a = k(a)),
            (a = "\n\n" + a + "\n\n"),
            (a = d.subParser("detab")(a, l, b)),
            (a = d.subParser("stripBlankLines")(a, l, b)),
            d.helper.forEach(m, function (c) {
              a = d.subParser("runExtension")(c, a, l, b);
            }),
            (a = d.subParser("hashPreCodeTags")(a, l, b)),
            (a = d.subParser("githubCodeBlocks")(a, l, b)),
            (a = d.subParser("hashHTMLBlocks")(a, l, b)),
            (a = d.subParser("hashHTMLSpans")(a, l, b)),
            (a = d.subParser("stripLinkDefinitions")(a, l, b)),
            (a = d.subParser("blockGamut")(a, l, b)),
            (a = d.subParser("unhashHTMLSpans")(a, l, b)),
            (a = d.subParser("unescapeSpecialChars")(a, l, b)),
            (a = a.replace(/~D/g, "$$")),
            (a = a.replace(/~T/g, "~")),
            d.helper.forEach(n, function (c) {
              a = d.subParser("runExtension")(c, a, l, b);
            }),
            a
          );
        ...
        (this.removeExtension = function (a) {
          ...
          for (var b = 0; b < a.length; ++b) {
            for (var c = a[b], e = 0; e < m.length; ++e)
              m[e] === c && m[e].splice(e, 1);
      ...
      var e = function (a, b, e, f, g, h, i, j) {
        ...
        if (!m)
          if (
            ...
            (m = "#" + l),
            d.helper.isUndefined(c.gUrls[l]))
          ) {
            if (!(a.search(/\(\s*\)$/m) > -1)) return a;
            m = "";
          } else
            (m = c.gUrls[l]),
              d.helper.isUndefined(c.gTitles[l]) || (n = c.gTitles[l]);
        ...
        return (
          "" !== n &&
            null !== n &&
            ((n = n.replace(/"/g, "&quot;")),
            (n = d.helper.escapeCharacters(n, "*_", !1)),
            (o += ' title="' + n + '"')),
          (o += ">" + k + "</a>")
        );
      };
    ...
    d.subParser("autoLinks", function (a, b, c) {
      ...
      function e(a, c, d, e, f) {
        var g = c,
          h = "";
        return (
          /^www\./i.test(c) && (c = c.replace(/^www\./i, "http://www.")),
      ...
      var g = /\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)()(?=\s|$)(?!["<>])/gi,
        h = /\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?()]?)(?=\s|$)(?!["<>])/gi,
        i = /<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi,
        j = /(?:^|\s)([A-Za-z0-9!#$%&'*+-\/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|\s)/gi,
        k = /<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
      return (
        (a = a.replace(i, e)),
        (a = a.replace(k, f)),
    ...
    d.subParser("blockGamut", function (a, b, c) {
      ...
      (a = c.converter._dispatch("blockGamut.before", a, b, c)),
        (a = d.subParser("blockQuotes")(a, b, c)),
        (a = d.subParser("headers")(a, b, c));
      var e = d.subParser("hashBlock")("<hr />", b, c);
      return (
        (a = a.replace(/^ {0,2}( ?-){3,}[ \t]*$/gm, e)),
        (a = a.replace(/^ {0,2}( ?\*){3,}[ \t]*$/gm, e)),
        (a = a.replace(/^ {0,2}( ?_){3,}[ \t]*$/gm, e)),
        (a = d.subParser("lists")(a, b, c)),
        (a = d.subParser("codeBlocks")(a, b, c)),
        (a = d.subParser("tables")(a, b, c)),
        (a = d.subParser("hashHTMLBlocks")(a, b, c)),
      ...
      return (
        ...
        (a = a.replace(/((^ {0,3}>[ \t]?.+\n(.+\n)*\n*)+)/gm, function (a, e) {
          ...
          return (
            ...
            (f = f.replace(/~0/g, "")),
            (f = f.replace(/^[ \t]+$/gm, "")),
            (f = d.subParser("githubCodeBlocks")(f, b, c)),
            (f = d.subParser("blockGamut")(f, b, c)),
            (f = f.replace(/(^|\n)/g, "$1  ")),
            (f = f.replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (a, b) {
              var c = b;
              return (c = c.replace(/^  /gm, "~0")), (c = c.replace(/~0/g, ""));
            })),
            d.subParser("hashBlock")(
              "<blockquote>\n" + f + "\n</blockquote>",
              b,
              c
            )
      ...
      return (
        (a = a.replace(e, function (a, e, f) {
          var g = e,
            ...
            i = "\n";
          return (
            (g = d.subParser("outdent")(g)),
            (g = d.subParser("encodeCode")(g)),
            (g = d.subParser("detab")(g)),
            (g = g.replace(/^\n+/g, "")),
            (g = g.replace(/\n+$/g, "")),
            b.omitExtraWLInCodeBlocks && (i = ""),
            (g = "<pre><code>" + g + i + "</code></pre>"),
            d.subParser("hashBlock")(g, b, c) + h
          );
        })),
        (a = a.replace(/~0/, "")),
    ...
    d.subParser("encodeBackslashEscapes", function (a) {
      "use strict";
      return (
        (a = a.replace(/\\(\\)/g, d.helper.escapeCharactersCallback)),
        (a = a.replace(
          /\\([`*_{}\[\]()>#+-.!])/g,
          d.helper.escapeCharactersCallback
        ))
      );
    }),
    ...
    d.subParser("githubCodeBlocks", function (a, b, c) {
      ...
      return b.ghCodeBlocks
        ? ((a = c.converter._dispatch("githubCodeBlocks.before", a, b, c)),
          (a += "~0"),
          (a = a.replace(/(?:^|\n)```(.*)\n([\s\S]*?)\n```/g, function (
            a,
            e,
            ...
            return (
              (f = d.subParser("encodeCode")(f)),
              (f = d.subParser("detab")(f)),
              (f = f.replace(/^\n+/g, "")),
              (f = f.replace(/\n+$/g, "")),
              (f =
                "<pre><code" +
                (e ? ' class="' + e + " language-" + e + '"' : "") +
                ">" +
                f +
                g +
                "</code></pre>"),
              ...
              "\n\n~G" +
                (c.ghCodeBlocks.push({ text: a, codeblock: f }) - 1) +
                "G\n\n"
            );
          })),
          (a = a.replace(/~0/, "")),
    ...
    d.subParser("hashHTMLBlocks", function (a, b, c) {
      ...
      for (
        ...
        a = d.helper.replaceRecursiveRegExp(
          a,
          f,
          "^ {0,3}<" + e[g] + "\\b[^>]*>",
          "</" + e[g] + ">",
    ...
    d.subParser("hashHTMLSpans", function (a, b, c) {
      "use strict";
      for (
        var e = d.helper.matchRecursiveRegExp(
            a,
            "<code\\b[^>]*>",
            "</code>",
            "gi"
        ...
        a = a.replace(e[f][0], "~C" + (c.gHtmlSpans.push(e[f][0]) - 1) + "C");
      return a;
    }),
    d.subParser("unhashHTMLSpans", function (a, b, c) {
      "use strict";
      for (var d = 0; d < c.gHtmlSpans.length; ++d)
        a = a.replace("~C" + d + "C", c.gHtmlSpans[d]);
      return a;
    }),
    d.subParser("hashPreCodeTags", function (a, b, c) {
      ...
      var e = function (a, b, e, f) {
        ...
        return (
          "\n\n~G" +
          (c.ghCodeBlocks.push({ text: a, codeblock: g }) - 1) +
          "G\n\n"
        );
      };
      return (a = d.helper.replaceRecursiveRegExp(
        a,
        e,
        "^ {0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>",
        "^ {0,3}</code>\\s*</pre>",
    ...
    d.subParser("headers", function (a, b, c) {
      ...
      function e(a) {
        var b,
          e = a.replace(/[^\w]/g, "").toLowerCase();
        return (
          c.hashLinkCounts[e]
            ? (b = e + "-" + c.hashLinkCounts[e]++)
            : ((b = e), (c.hashLinkCounts[e] = 1)),
          f === !0 && (f = "section"),
          d.helper.isString(f) ? f + b : b
        );
      }
      a = c.converter._dispatch("headers.before", a, b, c);
      var f = b.prefixHeaderId,
        g = isNaN(parseInt(b.headerLevelStart))
          ? 1
      ...
      function e(a, b, e, f, g, h, i, j) {
        ...
        if (((e = e.toLowerCase()), j || (j = ""), "" === f || null === f)) {
          if (
            ...
            (f = "#" + e),
            d.helper.isUndefined(k[e]))
          )
            return a;
          (f = k[e]),
            d.helper.isUndefined(l[e]) || (j = l[e]),
            d.helper.isUndefined(m[e]) || ((g = m[e].width), (h = m[e].height));
        }
        (b = b.replace(/"/g, "&quot;")),
          (b = d.helper.escapeCharacters(b, "*_", !1)),
          (f = d.helper.escapeCharacters(f, "*_", !1));
        var n = '<img src="' + f + '" alt="' + b + '"';
        return (
          j &&
            ((j = j.replace(/"/g, "&quot;")),
            (j = d.helper.escapeCharacters(j, "*_", !1)),
            (n += ' title="' + j + '"')),
          g &&
            h &&
            ((g = "*" === g ? "auto" : g),
      ...
      function e(a, e) {
        ...
        return (
          b.disableForced4SpacesIndentedSublists &&
            (f = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(~0|\2([*+-]|\d+[.])[ \t]+))/gm),
          (a = a.replace(f, function (a, e, f, h, i, j, k) {
            k = k && "" !== k.trim();
            ...
            return (
              j &&
                b.tasklists &&
                ((m = ' class="task-list-item" style="list-style-type: none;"'),
              ...
              e || l.search(/\n{2,}/) > -1
                ? ((l = d.subParser("githubCodeBlocks")(l, b, c)),
                  (l = d.subParser("blockGamut")(l, b, c)))
                : ((l = d.subParser("lists")(l, b, c)),
                  (l = l.replace(/\n$/, "")),
                  (l = d.subParser("hashHTMLBlocks")(l, b, c)),
                  (l = l.replace(/\n\n+/g, "\n\n")),
                  (l = g
                    ? d.subParser("paragraphs")(l, b, c)
                    : d.subParser("spanGamut")(l, b, c))),
              (l = l.replace("~A", "")),
              (l = "<li" + m + ">" + l + "</li>\n")
            );
          })),
    ...
    d.subParser("outdent", function (a) {
      "use strict";
      return (
        (a = a.replace(/^(\t|[ ]{1,4})/gm, "~0")), (a = a.replace(/~0/g, ""))
      );
    }),
        ...
        for (var j = "", k = f[h], l = !1; k.search(/~(K|G)(\d+)\1/) >= 0; ) {
          ...
          (j =
            "K" === m
              ? c.gHtmlBlocks[n]
              : l
              ? d.subParser("encodeCode")(c.ghCodeBlocks[n].text)
    ...
    d.subParser("spanGamut", function (a, b, c) {
      ...
      return (
        ...
        (a = d.subParser("codeSpans")(a, b, c)),
        (a = d.subParser("escapeSpecialCharsWithinTagAttributes")(a, b, c)),
        (a = d.subParser("encodeBackslashEscapes")(a, b, c)),
        (a = d.subParser("images")(a, b, c)),
        (a = d.subParser("anchors")(a, b, c)),
        (a = d.subParser("autoLinks")(a, b, c)),
        (a = d.subParser("encodeAmpsAndAngles")(a, b, c)),
        (a = d.subParser("italicsAndBold")(a, b, c)),
        (a = d.subParser("strikethrough")(a, b, c)),
    ...
    d.subParser("strikethrough", function (a, b, c) {
      ...
      return (
        b.strikethrough &&
          ((a = c.converter._dispatch("strikethrough.before", a, b, c)),
          (a = a.replace(/(?:~T){2}([\s\S]+?)(?:~T){2}/g, "<del>$1</del>")),
          (a = c.converter._dispatch("strikethrough.after", a, b, c))),
        a
      );
    }),
    ...
    d.subParser("stripLinkDefinitions", function (a, b, c) {
      ...
      return (
        (a += "~0"),
        (a = a.replace(e, function (a, e, f, g, h, i, j) {
          return (
            (e = e.toLowerCase()),
            (c.gUrls[e] = d.subParser("encodeAmpsAndAngles")(f)),
            i
              ? i + j
              : (j && (c.gTitles[e] = j.replace(/"|'/g, "&quot;")),
                b.parseImgDimensions &&
                  g &&
                  h &&
                  (c.gDimensions[e] = { width: g, height: h }),
                "")
          );
        })),
        (a = a.replace(/~0/, ""))
    ...
    d.subParser("tables", function (a, b, c) {
      ...
      function f(a, e) {
        ...
        return (
          (a = a.trim()),
          b.tableHeaderId &&
            (f = ' id="' + a.replace(/ /g, "_").toLowerCase() + '"'),
          (a = d.subParser("spanGamut")(a, b, c)),
          "<th" + f + e + ">" + a + "</th>\n"
        );
      }
      function g(a, e) {
      ...
      return (
        ...
        (a = a.replace(i, function (a) {
          ...
          for (b = 0; b < c.length; ++b)
            /^ {0,3}\|/.test(c[b]) && (c[b] = c[b].replace(/^ {0,3}\|/, "")),
              /\|[ \t]*$/.test(c[b]) && (c[b] = c[b].replace(/\|[ \t]*$/, ""));
          ...
          for (b = 0; b < i.length; ++b)
            d.helper.isUndefined(m[b]) && (m[b] = ""), l.push(f(i[b], m[b]));
          for (b = 0; b < k.length; ++b) {
            for (var o = [], p = 0; p < l.length; ++p)
              d.helper.isUndefined(k[b][p]), o.push(g(k[b][p], m[p]));
            n.push(o);
          }
          return h(l, n);
        })),
