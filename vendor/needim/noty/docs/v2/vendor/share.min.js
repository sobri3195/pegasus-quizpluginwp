    ...
    (ShareUtils = (function () {
      ...
      return (
        ...
        (t.prototype.encode = function (t) {
          return "undefined" == typeof t || this.is_encoded(t)
            ? t
            : t.to_rfc3986();
        }),
  ...
  Share = (function (t) {
    ...
    return (
      ...
      (e.prototype.event_toggle = function (t) {
        return this.has_class(t, "active")
          ? this.event_close(t)
          : this.event_open(t);
      }),
      (e.prototype.event_open = function (t) {
        return (
          this.has_class(t, "load") && this.remove_class(t, "load"),
      ...
      (e.prototype.event_network = function (t, e) {
        var o;
        return (
          (o = e.getAttribute("data-network")),
          this.hook("before", o, t),
          this["network_" + o](),
          this.hook("after", o, t)
        );
      }),
      ...
      (e.prototype["public"] = function (t) {
        var e, o, n, i, r, s, c;
        for (
          s = document.querySelectorAll(this.element),
            c = [],
            o = i = 0,
            r = s.length;
          r > i;
      ...
      (e.prototype.inject_fonts = function () {
        return this.inject_stylesheet(
          "http://fonts.googleapis.com/css?family=Lato:900&text=" +
            this.config.ui.button_text
        );
      }),
      (e.prototype.inject_stylesheet = function (t) {
        var e;
        return this.el.head.querySelector('link[href="' + t + '"]')
          ? void 0
      ...
      (e.prototype.inject_html = function (t) {
        return (t.innerHTML =
          ...
          "'><ul><li class='entypo-pinterest' data-network='pinterest'></li><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li></ul></div>");
      }),
      ...
      (e.prototype.hook = function (t, e, o) {
        ...
        (n = this.config.networks[e][t]),
          "function" == typeof n &&
            ((i = n.call(this.config.networks[e], o)),
            void 0 !== i &&
              ((i = this.normalize_filter_config_updates(i)),
              this.extend(this.config.networks[e], i, !0),
              this.normalize_network_configuration()));
      }),
      (e.prototype.set_global_configuration = function () {
        ...
        for (e in i) {
          n = i[e];
          for (o in n)
            null == this.config.networks[e][o] &&
              (this.config.networks[e][o] = this.config[o]);
          this.config.networks[e].enabled
            ? ((t = "block"), (this.config.enabled_networks += 1))
            : (t = "none"),
            r.push((this.config.networks[e].display = t));
        }
        return r;
      }),
