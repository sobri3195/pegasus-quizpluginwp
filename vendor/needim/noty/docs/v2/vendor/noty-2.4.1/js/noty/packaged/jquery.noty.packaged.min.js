!(function (a, b) {
  ...
  var b = {
    ...
    _build: function () {
      ...
      if (this.options.progressBar && this.options.timeout) {
        ...
        null !== this.options.layout.parent.object
          ? this.$bar.find(".noty_bar").append(e)
          : this.$bar.append(e);
      }
    ...
    show: function () {
      ...
      return (
        ...
        b.options.layout.container.style.apply(
          a(b.options.layout.container.selector),
          [b.options.within]
        ),
        (b.showing = !0),
        b.options.theme &&
    ...
    bindTimeout: function () {
      var a = this;
      a.options.timeout &&
        (a.options.progressBar &&
          a.$progressBar &&
          a.$progressBar.css({
            transition: "all " + a.options.timeout + "ms linear",
            width: "0%",
          }),
        a.queueClose(a.options.timeout),
        a.$bar.on("mouseenter", a.dequeueClose.bind(a)),
        a.$bar.on("mouseleave", a.queueClose.bind(a, a.options.timeout)));
    },
    dequeueClose: function () {
      var a = this;
      a.options.progressBar &&
        this.$progressBar.css({ transition: "none", width: "100%" }),
        this.closeTimer &&
    ...
    queueClose: function (a) {
      var b = this;
      if (
        (b.options.progressBar &&
          b.$progressBar.css({
            transition: "all " + b.options.timeout + "ms linear",
            width: "0%",
          }),
        !this.closeTimer)
      )
    ...
    handleNext: function () {
      ...
      delete a.noty.store[b.options.id],
        ...
        b.options.dismissQueue ||
          ((a.noty.ontap = !0), a.notyRenderer.render()),
    ...
    setText: function (a) {
      return (
        this.closed ||
          ((this.options.text = a), this.$bar.find(".noty_text").html(a)),
        this
      );
    },
    setType: function (a) {
  ...
  (a.notyRenderer = {}),
    ...
    (a.notyRenderer.show = function (b) {
      b.options.modal &&
        (a.notyRenderer.createModalFor(b), a.notyRenderer.setModalCount(1)),
        b.options.custom
          ? 0 ==
            b.options.custom.find(b.options.layout.container.selector).length
    ...
    (a.notyRenderer.getLayoutCountFor = function (b) {
      return (
        a(b.options.layout.container.selector).data("noty_layout_count") || 0
      );
    }),
          ...
          b.remove(),
            a(this).hasClass("i-am-new")
              ...
              : a(this).animate(
                  {
                    left:
                      (a(window).width() - a(this).outerWidth(!1)) / 2 + "px",
                    top: (a(window).height() - c) / 2 + "px",
                  },
                  500
                );
            ...
            switch (this.options.layout.name) {
              case "top":
                a(b).css({ borderRadius: "0px 0px 0px 0px" }),
                  a(b).last().css({ borderRadius: "0px 0px 5px 5px" });
                break;
              case "topCenter":
              case "topLeft":
              case "topRight":
              ...
              case "bottom":
                a(b).css({ borderRadius: "0px 0px 0px 0px" }),
                  a(b).first().css({ borderRadius: "5px 5px 0px 0px" });
            }
          }
        },
      },
    ...
    (a.noty.themes.semanticUI = {
      ...
      style: function () {
        switch (
          ...
          this.$bar.css({ margin: "0.5em", position: "relative" }),
          this.options.icon &&
            this.$message
              .addClass("icon")
