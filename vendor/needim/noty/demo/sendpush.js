...
webpush.sendNotification(
  ...
  JSON.stringify({
    ...
    image:
      "https://cdn.dribbble.com/users/252805/screenshots/2760603/dribbble-notification.png",
    ...
    actions: [
      {
        ...
        title: "Yes",
        icon:
          "https://cdn2.iconfinder.com/data/icons/navigation-set-arrows-part-two/32/Check-128.png",
      },
      {
        action: "actionNo",
        title: "No",
        icon:
          "https://cdn0.iconfinder.com/data/icons/navigation-set-arrows-part-one/32/Close-128.png",
      },
    ],
  })
);
