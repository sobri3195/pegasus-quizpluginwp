  ...
  })(
    {
      ...
      5: [
        function (e, t, n) {
          ...
          var f = {
            ...
            on: function (e, t) {
              return (
                this._subCallbacks[e] || (this._subCallbacks[e] = {}),
                (this._id += 1),
                (this._subCallbacks[e][this._id] = t),
                (this._subSignals[this._id] = e),
                this._id
              );
            },
            off: function (e) {
          ...
          function r() {
            ...
            function t(e, t) {
              if (!this.hasNamespace(o)) {
                var n = r.get(t, Number.MAX_VALUE);
                n <= new Date().getTime() && this.remove(t);
              }
              return e();
            }
            function n(e, t) {
          ...
          function r() {
            ...
            function i(e, t, n, r, i, s) {
              ...
              return this.update(t, {}, function (e) {
                ...
                return c.unshift(e), a.apply(Object, c);
              });
            }
            function s(e, t) {
              var n,
        ...
        function (e, t, n) {
          ...
          var p = {
            ...
            addPlugin: function (e) {
              var t = this;
              if (c(e))
                return void a(e, function (e) {
                  t.addPlugin(e);
                });
              var n = u(this._seenPlugins, function (t) {
                return e === t;
              });
              if (!n) {
                if ((this._seenPlugins.push(e), !f(e)))
                  throw new Error(
      ...
      15: [
        ...
        },
        {
          ...
          "./localStorage": 17,
          "./memoryStorage": 18,
          "./oldFF-globalStorage": 19,
          "./oldIE-userDataStorage": 20,
          "./sessionStorage": 21,
        },
      ],
      16: [
