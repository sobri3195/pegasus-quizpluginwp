...
!(function (t, e) {
        ...
        (p = (function () {
          ...
          return (
            ...
            (e._removeElement = function (t) {
              var e = this;
              o(t).removeClass(d),
                gt.supportsTransitionEnd() && o(t).hasClass(u)
                  ? o(t)
          ...
          return (
            ...
            (e._slide = function (t, e) {
              ...
              if (
                ...
                gt.supportsTransitionEnd() && k(this._element).hasClass(Y)
                  ? (k(l).addClass(i),
                    gt.reflow(l),
                    k(s).addClass(n),
                    k(l).addClass(n),
  ...
  function kt(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(r))
      return "BODY" === (a = (s = l).nodeName) ||
        ("HTML" !== a && Ot(s.firstElementChild) !== s)
        ? Ot(l)
        : l;
    var c = Nt(t);
  ...
  var xt = void 0,
    Rt = function () {
      return (
        void 0 === xt && (xt = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        xt
      );
    };
  function jt(t, e, n, i) {
    ...
    return (
      (void 0 === n
        ...
        t.enabled &&
          ...
          (e.offsets.reference = Bt(e.offsets.reference)),
          (e = n(e, t)));
      }),
      e
    );
  ...
  function ne(t, e, n, i) {
    (n.updateBound = i),
      ee(t).addEventListener("resize", n.updateBound, { passive: !0 });
    var r = St(t);
    return (
      (function t(e, n, i, r) {
      ...
      modifiers: {
            ...
            return (
              s.forEach(function (a, l) {
                ...
                (d || v || y) &&
                  ...
                  (t = Zt(t.instance.modifiers, t, "flip")));
              }),
              t
            );
          },
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            return (
              (t.attributes = Ft({}, _, t.attributes)),
              (t.styles = Ft({}, l, t.styles)),
              (t.arrowStyles = Ft({}, t.offsets.arrow, t.arrowStyles)),
              t
            );
          },
          gpuAcceleration: !0,
          ...
          fn: function (t) {
            ...
            return (
              ...
              t.arrowElement &&
                ...
                oe(t.arrowElement, t.arrowStyles),
              t
            );
          },
    ...
    de = (function () {
      function t(e, n) {
        ...
        Mt(this, t),
          ...
          (this.options = Ft({}, t.Defaults, r)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = e && e.jquery ? e[0] : e),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(Ft({}, t.Defaults.modifiers, r.modifiers)).forEach(
            function (e) {
              i.options.modifiers[e] = Ft(
                {},
  ...
  var pe,
    ...
    yi =
      ...
      (ke = ".dropdown-menu"),
      (Le = ".navbar-nav"),
      (Pe = ".dropdown-menu .dropdown-item:not(.disabled)"),
      (xe = "top-start"),
      (Re = "top-end"),
      (je = "bottom-start"),
      (He = "bottom-end"),
      ...
      (Be = (function () {
        ...
        return (
            ...
            if (!this._element.disabled && !pe(this._element).hasClass(Te)) {
              ...
              if ((t._clearMenus(), !n)) {
                ...
                if ((pe(e).trigger(r), !r.isDefaultPrevented())) {
                  ...
                  "ontouchstart" in document.documentElement &&
                    0 === pe(e).closest(Le).length &&
                    pe(document.body).children().on("mouseover", null, pe.noop),
                    this._element.focus(),
                    this._element.setAttribute("aria-expanded", !0),
                    pe(this._menu).toggleClass(Ce),
                    pe(e).toggleClass(Ce).trigger(pe.Event(be.SHOWN, i));
                }
              }
            }
          }),
          (e.dispose = function () {
            pe.removeData(this._element, me),
              pe(this._element).off(_e),
              (this._element = null),
              (this._menu = null),
              null !== this._popper &&
          ...
          (e._getConfig = function (t) {
            return (
              (t = r(
                ...
                pe(this._element).data(),
                t
              )),
              gt.typeCheckConfig(ge, t, this.constructor.DefaultType),
              t
            );
          }),
          ...
          (e._getPlacement = function () {
            ...
            return (
              t.hasClass(we)
                ? ((e = xe), pe(this._menu).hasClass(De) && (e = Re))
                : t.hasClass(Ie)
                ? (e = Me)
                : t.hasClass(Ae)
                ? (e = We)
                : pe(this._menu).hasClass(De) && (e = He),
              e
            );
          }),
          ...
          (t._clearMenus = function (e) {
            if (!e || (3 !== e.which && ("keyup" !== e.type || 9 === e.which)))
              for (var n = pe.makeArray(pe(Oe)), i = 0; i < n.length; i++) {
                  ...
                  if (
                    ...
                    pe(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        pe(a).removeClass(Ce),
                        pe(r).removeClass(Ce).trigger(pe.Event(be.HIDDEN, s)));
                  }
                }
              }
          }),
                ...
                ? !(
                    ...
                    (27 !== e.which &&
                      ((40 !== e.which && 38 !== e.which) ||
                        pe(e.target).closest(ke).length))
                  )
                : ye.test(e.which)) &&
              (e.preventDefault(),
              e.stopPropagation(),
              !this.disabled && !pe(this).hasClass(Te))
            ) {
      ...
      pe(document)
        ...
        .on(be.CLICK_DATA_API + " " + be.KEYUP_DATA_API, Be._clearMenus)
        .on(be.CLICK_DATA_API, Oe, function (t) {
          t.preventDefault(),
            t.stopPropagation(),
            Be._jQueryInterface.call(pe(this), "toggle");
        })
        .on(be.CLICK_DATA_API, Ne, function (t) {
          t.stopPropagation();
        }),
      (pe.fn[ge] = Be._jQueryInterface),
      (pe.fn[ge].Constructor = Be),
    ...
    bi =
      ...
      (Ye = "." + (Qe = "bs.modal")),
      (Ge = (Ke = e).fn[Ve]),
      (qe = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }),
      (ze = {
      ...
      (rn = (function () {
        function t(t, e) {
          (this._config = this._getConfig(e)),
            (this._element = t),
            (this._dialog = Ke(t).find(nn.DIALOG)[0]),
            (this._backdrop = null),
            (this._isShown = !1),
        ...
        return (
          ...
          (e.hide = function (t) {
            ...
            if (
              ...
              if (
                ...
                this._isShown = !1;
                var i =
                  gt.supportsTransitionEnd() && Ke(this._element).hasClass(tn);
                i && (this._isTransitioning = !0),
                  this._setEscapeEvent(),
                  this._setResizeEvent(),
                  Ke(document).off(Xe.FOCUSIN),
                  Ke(this._element).removeClass(en),
                  Ke(this._element).off(Xe.CLICK_DISMISS),
                  Ke(this._dialog).off(Xe.MOUSEDOWN_DISMISS),
                  i
                    ? Ke(this._element)
          ...
          (e.dispose = function () {
            Ke.removeData(this._element, Qe),
              Ke(window, document, this._element, this._backdrop).off(Ye),
              (this._config = null),
              (this._element = null),
              (this._dialog = null),
              (this._backdrop = null),
          ...
          (e._showElement = function (t) {
            ...
            (this._element.parentNode &&
              ...
              Ke(this._element).addClass(en),
              this._config.focus && this._enforceFocus();
            var i = Ke.Event(Xe.SHOWN, { relatedTarget: t }),
              r = function () {
                e._config.focus && e._element.focus(),
                  (e._isTransitioning = !1),
                  Ke(e._element).trigger(i);
              };
            n
              ? Ke(this._dialog)
          ...
          (e._setEscapeEvent = function () {
            ...
            this._isShown && this._config.keyboard
              ? Ke(this._element).on(Xe.KEYDOWN_DISMISS, function (e) {
          ...
          (e._setResizeEvent = function () {
            var t = this;
            this._isShown
              ? Ke(window).on(Xe.RESIZE, function (e) {
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                Ke(document.body).removeClass($e),
                  t._resetAdjustments(),
                  t._resetScrollbar(),
                  Ke(t._element).trigger(Xe.HIDDEN);
              });
          }),
          ...
          (e._showBackdrop = function (t) {
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              if (
                ...
                (this._backdrop.className = Ze),
                n && Ke(this._backdrop).addClass(n),
                Ke(this._backdrop).appendTo(document.body),
                Ke(this._element).on(Xe.CLICK_DISMISS, function (t) {
                ...
                i && gt.reflow(this._backdrop),
                Ke(this._backdrop).addClass(en),
                !t)
              )
                return;
              if (!i) return void t();
          ...
          (e._resetScrollbar = function () {
            Ke(nn.FIXED_CONTENT).each(function (t, e) {
              ...
              "undefined" != typeof n &&
                Ke(e).css("padding-right", n).removeData("padding-right");
            }),
              Ke(nn.STICKY_CONTENT + ", " + nn.NAVBAR_TOGGLER).each(function (
                t,
                e
              ) {
                var n = Ke(e).data("margin-right");
                "undefined" != typeof n &&
                  Ke(e).css("margin-right", n).removeData("margin-right");
              });
          ...
          (t._jQueryInterface = function (e, n) {
            return this.each(function () {
              ...
              if (
                (i || ((i = new t(this, o)), Ke(this).data(Qe, i)),
                "string" == typeof e)
              ) {
                if ("undefined" == typeof i[e])
                  throw new TypeError('No method named "' + e + '"');
      ...
      (Ke.fn[Ve] = rn._jQueryInterface),
      (Ke.fn[Ve].Constructor = rn),
      (Ke.fn[Ve].noConflict = function () {
    ...
    Ti =
        ...
        return (
            ...
            if (this._isEnabled)
              if (t) {
                ...
                n ||
                  ...
                  on(t.currentTarget).data(e, n)),
                  (n._activeTrigger.click = !n._activeTrigger.click),
                  n._isWithActiveTrigger()
                    ? n._enter(null, n)
                    : n._leave(null, n);
              } else {
                if (on(this.getTipElement()).hasClass(En))
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              on.removeData(this.element, this.constructor.DATA_KEY),
              on(this.element).off(this.constructor.EVENT_KEY),
              on(this.element).closest(".modal").off("hide.bs.modal"),
              this.tip && on(this.tip).remove(),
          ...
          (e.show = function () {
            var e = this;
            if ("none" === on(this.element).css("display"))
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              r.setAttribute("id", o),
                ...
                this.setContent(),
                this.config.animation && on(r).addClass(vn);
              var s =
              ...
              var l =
                !1 === this.config.container
                  ? document.body
                  : on(this.config.container);
              on(r).data(this.constructor.DATA_KEY, this),
                on.contains(
                  this.element.ownerDocument.documentElement,
                  this.tip
                ) || on(r).appendTo(l),
                on(this.element).trigger(this.constructor.Event.INSERTED),
                (this._popper = new de(this.element, r, {
                  placement: a,
                  modifiers: {
                ...
                on(r).addClass(En),
                "ontouchstart" in document.documentElement &&
                  on(document.body).children().on("mouseover", null, on.noop);
              var c = function () {
                e.config.animation && e._fixTransition();
                var t = e._hoverState;
                (e._hoverState = null),
                  on(e.element).trigger(e.constructor.Event.SHOWN),
                  t === mn && e._leave(null, e);
              };
              gt.supportsTransitionEnd() && on(this.tip).hasClass(vn)
                ? on(this.tip)
                    .one(gt.TRANSITION_END, c)
            ...
            var e = this,
              ...
              r = function () {
                e._hoverState !== gn &&
                  ...
                  on(e.element).trigger(e.constructor.Event.HIDDEN),
                  null !== e._popper && e._popper.destroy(),
                  t && t();
              };
            on(this.element).trigger(i),
              i.isDefaultPrevented() ||
                (on(n).removeClass(En),
                "ontouchstart" in document.documentElement &&
                  on(document.body).children().off("mouseover", null, on.noop),
                (this._activeTrigger[wn] = !1),
                (this._activeTrigger[Cn] = !1),
                (this._activeTrigger[Tn] = !1),
                gt.supportsTransitionEnd() && on(this.tip).hasClass(vn)
                  ? on(n).one(gt.TRANSITION_END, r).emulateTransitionEnd(150)
                  : r(),
                (this._hoverState = ""));
          }),
          (e.update = function () {
          ...
          (e.setElementContent = function (t, e) {
            ...
            "object" == typeof e && (e.nodeType || e.jquery)
              ? n
                ? on(e).parent().is(t) || t.empty().append(e)
                : t.text(on(e).text())
              : t[n ? "html" : "text"](e);
          }),
          (e.getTitle = function () {
          ...
          (e._enter = function (t, e) {
            ...
            (e = e || on(t.currentTarget).data(n)) ||
              ((e = new this.constructor(
                t.currentTarget,
                this._getDelegateConfig()
              )),
              on(t.currentTarget).data(n, e)),
              t && (e._activeTrigger["focusin" === t.type ? Cn : Tn] = !0),
              on(e.getTipElement()).hasClass(En) || e._hoverState === gn
                ? (e._hoverState = gn)
          ...
          (e._leave = function (t, e) {
            ...
            (e = e || on(t.currentTarget).data(n)) ||
              ...
              on(t.currentTarget).data(n, e)),
              t && (e._activeTrigger["focusout" === t.type ? Cn : Tn] = !1),
            ...
            return (
              "number" ==
                typeof (t = r(
                  {},
                  this.constructor.Default,
                  on(this.element).data(),
                  t
                )).delay && (t.delay = { show: t.delay, hide: t.delay }),
              "number" == typeof t.title && (t.title = t.title.toString()),
              "number" == typeof t.content &&
                (t.content = t.content.toString()),
              gt.typeCheckConfig(sn, t, this.constructor.DefaultType),
              t
            );
          }),
          ...
          (t._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new t(this, i)), on(this).data(an, n)),
                "string" == typeof e)
              ) {
                if ("undefined" == typeof n[e])
                  throw new TypeError('No method named "' + e + '"');
      ...
      (on.fn[sn] = An._jQueryInterface),
      (on.fn[sn].Constructor = An),
    ...
    Ci =
      ...
      (Rn = r({}, Ti.DefaultType, { content: "(string|element|function)" })),
      (jn = "fade"),
      (Hn = "show"),
      (Mn = ".popover-header"),
      (Wn = ".popover-body"),
      ...
      (Fn = (function (t) {
        ...
        return (
          ...
          (o.getTipElement = function () {
            return (
              (this.tip = this.tip || Dn(this.config.template)[0]), this.tip
            );
          }),
          (o.setContent = function () {
            ...
            "function" == typeof e && (e = e.call(this.element)),
              this.setElementContent(t.find(Wn), e),
              t.removeClass(jn + " " + Hn);
          }),
          ...
          (r._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                ...
                (e || ((e = new r(this, n)), Dn(this).data(On, e)),
                "string" == typeof t)
              ) {
      ...
      (Dn.fn[Sn] = Fn._jQueryInterface),
      (Dn.fn[Sn].Constructor = Fn),
      (Dn.fn[Sn].noConflict = function () {
    ...
    wi =
      ...
      (qn = { offset: "number", method: "string", target: "(string|element)" }),
      (zn = {
      ...
      (ei = (function () {
        function t(t, e) {
          ...
          (this._element = t),
            ...
            Bn(this._scrollElement).on(zn.SCROLL, function (t) {
              return n._process(t);
            }),
            this.refresh(),
            this._process();
        ...
        return (
          (e.refresh = function () {
            ...
            (this._offsets = []),
              ...
              Bn.makeArray(Bn(this._selector))
                .map(function (t) {
                  var e,
          ...
          (e.dispose = function () {
            Bn.removeData(this._element, Vn),
              Bn(this._scrollElement).off(Qn),
              (this._element = null),
          ...
          (e._getConfig = function (t) {
            if ("string" != typeof (t = r({}, Gn, t)).target) {
              ...
              e || ((e = gt.getUID(Kn)), Bn(t.target).attr("id", e)),
                (t.target = "#" + e);
            }
          ...
          (e._activate = function (t) {
            ...
            var n = Bn(e.join(","));
            n.hasClass(Xn)
              ? (n.closest(Zn.DROPDOWN).find(Zn.DROPDOWN_TOGGLE).addClass(Jn),
                n.addClass(Jn))
              : (n.addClass(Jn),
                n
                  .parents(Zn.NAV_LIST_GROUP)
                  .prev(Zn.NAV_LINKS + ", " + Zn.LIST_ITEMS)
                  .addClass(Jn),
                n
                  .parents(Zn.NAV_LIST_GROUP)
                  .prev(Zn.NAV_ITEMS)
                  .children(Zn.NAV_LINKS)
                  .addClass(Jn)),
              Bn(this._scrollElement).trigger(zn.ACTIVATE, {
                relatedTarget: t,
              });
          }),
          (e._clear = function () {
      ...
      (Bn.fn[Kn] = ei._jQueryInterface),
      (Bn.fn[Kn].Constructor = ei),
    ...
    Ii =
      ...
      (Ei = (function () {
        ...
        return (
          (e.show = function () {
            ...
            if (
              !(
                (this._element.parentNode &&
                  this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                  ni(this._element).hasClass(li)) ||
                ni(this._element).hasClass(ci)
              )
            ) {
              var e,
                n,
              ...
              var s = ni.Event(si.HIDE, { relatedTarget: this._element }),
                a = ni.Event(si.SHOW, { relatedTarget: n });
              if (
                (n && ni(n).trigger(s),
                ni(this._element).trigger(a),
                !a.isDefaultPrevented() && !s.isDefaultPrevented())
              ) {
                r && (e = ni(r)[0]), this._activate(this._element, i);
                var l = function () {
                  var e = ni.Event(si.HIDDEN, { relatedTarget: t._element }),
                    i = ni.Event(si.SHOWN, { relatedTarget: n });
          ...
          (e._activate = function (t, e, n) {
            ...
            r && o
              ? ni(r).one(gt.TRANSITION_END, s).emulateTransitionEnd(150)
              : s();
          }),
          (e._transitionComplete = function (t, e, n) {
            ...
            if (
              ...
              gt.reflow(t),
              ni(t).addClass(fi),
              t.parentNode && ni(t.parentNode).hasClass(ai))
            ) {
              var r = ni(t).closest(ui)[0];
              r && ni(r).find(_i).addClass(li),
          ...
          (t._jQueryInterface = function (e) {
            return this.each(function () {
              var n = ni(this),
                i = n.data(ii);
              if (
                (i || ((i = new t(this)), n.data(ii, i)), "string" == typeof e)
              ) {
                if ("undefined" == typeof i[e])
                  throw new TypeError('No method named "' + e + '"');
                i[e]();
      ...
      (ni.fn.tab = Ei._jQueryInterface),
      (ni.fn.tab.Constructor = Ei),
