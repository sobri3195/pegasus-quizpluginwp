  ...
  return (
    ...
    (C.loadFromArgs = function (t) {
      ...
      t.data
        ...
        : t.url
        ? e.convertUrlToData(t.url, t.mimeType, t.headers, t.keys, function (
            i
          ) {
    ...
    (C.yFormat = function (t) {
      var e = this,
        i = e.config;
      return (i.axis_y_tick_format
        ? i.axis_y_tick_format
        : e.defaultValueFormat)(t);
    }),
    (C.y2Format = function (t) {
      var e = this,
        i = e.config;
      return (i.axis_y2_tick_format
        ...
        .on("mousemove", function () {
          ...
          i.dragging ||
            ...
            !i.mouseover ||
              ...
              (i.mouseover = void 0)),
            o
              ? ((s = (i.isScatterType(o) || !a.tooltip_grouped
                  ? [o]
                  : i.filterByX(c, o.x)
                ).map(function (t) {
                  return i.addName(t);
