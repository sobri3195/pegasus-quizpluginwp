  ...
  var isSupportTouch =
          ...
          return c.length
            ? d(c).reduce(
                function (a, c) {
                  var d = b(a);
                  return (
                    e(b(d), c) ? (d[d.length] = c) : (a[a.length] = [c]), a
                  );
                },
                [[a(c)]]
              )
    ...
    dom = (function () {
      var a = function (a) {
        ...
        g = function (b) {
          return (
            !a(b) && b && /^DIV|^P|^LI|^H[1-7]/.test(b.nodeName.toUpperCase())
          );
        },
        h = function (a) {
        ...
        ua = function (a) {
          return (
            a && !dom.isText(a) && list.contains(a.classList, "note-styletag")
          );
        };
      return {
        NBSP_CHAR: NBSP_CHAR,
  ...
  var key = (function () {
          ...
          try {
            c = $.extend(c, {
              ...
              "font-strikethrough": document.queryCommandState("strikethrough")
                ...
                : "normal",
              "font-family":
                document.queryCommandValue("fontname") || c["font-family"],
            });
          } catch (a) {}
          if (a.isOnList()) {
          ...
          if (e) {
            ...
            if (
              ...
              (f = f.concat(dom.listDescendant(d, dom.isEmptyAnchor))),
                ...
                (dom.isHeading(d) || dom.isPre(d) || dom.isCustomStyleTag(d)) &&
                  dom.isEmpty(d) &&
                  (d = dom.replace(d, "p"));
            }
          } else {
    ...
    TableResultAction = function (a, b, c, d) {
      ...
      function m(a) {
        switch (b) {
          case TableResultAction.where.Column:
            if (a.isColSpan) return TableResultAction.resultAction.SumSpanCount;
            if (a.isRowSpan && a.isVirtual)
              return TableResultAction.resultAction.Ignore;
            break;
          case TableResultAction.where.Row:
            if (a.isRowSpan) return TableResultAction.resultAction.SumSpanCount;
      ...
      (this.getActionList = function () {
        for (
          var a = b === TableResultAction.where.Row ? n.rowPos : -1,
            d = b === TableResultAction.where.Column ? n.colPos : -1,
            e = 0,
            f = !0;
          f;
      ...
      (this.tab = function (a, b) {
        ...
        (this.addRow = function (a, b) {
          for (
            var c = dom.ancestor(a.commonAncestor(), dom.isCell),
              d = $(c).closest("tr"),
              e = this.recoverAttributes(d),
              f = $("<tr" + e + "></tr>"),
              g = new TableResultAction(
                c,
            ...
            switch (j.action) {
              ...
              case TableResultAction.resultAction.SumSpanCount:
                if ("top" === b) {
                  if (
                    (j.baseCell.parent
                      ? j.baseCell.closest("tr").rowIndex
                      : 0) <= d[0].rowIndex
                  ) {
                    var l = $("<div></div>")
                      .append(
                        $("<td" + k + ">" + dom.blank + "</td>").removeAttr(
                          "rowspan"
                        )
                      )
                      .html();
        ...
        (this.addCol = function (a, b) {
          ...
          for (
            ...
            switch (h.action) {
              case TableResultAction.resultAction.AddCell:
                "right" === b
                  ? $(h.baseCell).after("<td" + i + ">" + dom.blank + "</td>")
        ...
        (this.deleteRow = function (a) {
          for (
            var b = dom.ancestor(a.commonAncestor(), dom.isCell),
              c = $(b).closest("tr"),
              d = c.children("td, th").index($(b)),
              e = c[0].rowIndex,
              f = new TableResultAction(
                b,
                TableResultAction.where.Row,
    ...
    Editor = function (a) {
      ...
      (this.fontSize = function (a) {
        ...
        (this.insertTable = this.wrapCommand(function (a) {
          ...
          this.createRange()
            .deleteContents()
            .insertNode(k.createTable(b[0], b[1], f));
        })),
        (this.addRow = function (a) {
          var b = this.createRange(e);
          b.isCollapsed() && b.isOnCell() && (o(), k.addRow(b, a), p());
        }),
        (this.addCol = function (a) {
          var b = this.createRange(e);
          b.isCollapsed() && b.isOnCell() && (o(), k.addCol(b, a), p());
        }),
        (this.deleteRow = function () {
          var a = this.createRange(e);
          a.isCollapsed() && a.isOnCell() && (o(), k.deleteRow(a), p());
        }),
        (this.deleteCol = function () {
          var a = this.createRange(e);
          a.isCollapsed() && a.isOnCell() && (o(), k.deleteCol(a), p());
        }),
        (this.deleteTable = function () {
          var a = this.createRange(e);
          a.isCollapsed() && a.isOnCell() && (o(), k.deleteTable(a), p());
        }),
    ...
    Fullscreen = function (a) {
      ...
      (this.resizeTo = function (a) {
        ...
        (this.onResize = function () {
          b.resizeTo({ h: g.height() - d.outerHeight() });
        }),
        (this.toggle = function () {
          c.toggleClass("fullscreen"),
            this.isFullscreen()
              ...
              : (g.off("resize", this.onResize),
                this.resizeTo({ h: e.data("orgHeight") }),
    ...
    Buttons = function (a) {
      ...
      (this.initialize = function () {
            ...
            a.memo("button.table", function () {
              return c
                .buttonGroup(
                  ...
                  {
                    callback: function (c) {
                      c.find(".note-dimension-picker-mousecatcher")
                        .css({
        ...
        (this.tableMoveHandler = function (a) {
          ...
          g.css({ width: j.c + "em", height: j.r + "em" }),
            f.data("value", j.c + "x" + j.r),
            3 < j.c &&
              j.c < e.insertTableMaxSize.col &&
              h.css({ width: j.c + 1 + "em" }),
            3 < j.r &&
              j.r < e.insertTableMaxSize.row &&
              h.css({ height: j.r + 1 + "em" }),
            d.html(j.c + " x " + j.r);
        });
    },
    Toolbar = function (a) {
      ...
      (this.initialize = function () {
        var a = e.dialogsInBody ? $(document.body) : d,
          b =
            ...
            (e.disableLinkTarget
              ? ""
              : '<div class="checkbox"><label for="sn-checkbox-open-in-new-window"><input type="checkbox" id="sn-checkbox-open-in-new-window" checked />' +
          ...
          return $.Deferred(function (e) {
            ...
            c.onDialogShown(b.$dialog, function () {
              ...
              g
                ...
                b.bindEnterKey(f, h);
              var k =
                void 0 !== d.isNewWindow
                  ? d.isNewWindow
                  : a.options.linkTargetBlank;
              i.prop("checked", k),
        ...
        (this.initialize = function () {
          this.$popover = c
            .popover({
              ...
              callback: function (a) {
                a.find(".popover-content").prepend(
      ...
      (this.initialize = function () {
        ...
        (this.createVideoNode = function (a) {
          ...
          if (d && 11 === d[1].length) {
            ...
            b = $("<iframe>")
              .attr("frameborder", 0)
              .attr("src", "//www.youtube.com/embed/" + y)
              .attr("width", "640")
              .attr("height", "360");
            ...
            b = $(
              ...
              .attr(
                "src",
                "http://v.qq.com/iframe/player.html?vid=" + z + "&amp;auto=0"
              );
          } else {
            if (!(t || v || x)) return !1;
            b = $("<video controls>")
        ...
        (this.replace = function () {
          ...
          if (b.length) {
            ...
            this.lastWordRange.insertNode(c),
              ...
              a.triggerEvent(
                "change",
                a.layoutInfo.editable.html(),
                a.layoutInfo.editable
              ),
              a.invoke("editor.focus");
          }
        }),
