...
!(function ($) {
  ...
  (Iconpicker.VERSION = "1.10.0"),
    (Iconpicker.ICONSET_EMPTY = { iconClass: "", iconClassFix: "", icons: [] }),
    (Iconpicker.ICONSET = {
      _custom: null,
    ...
    (Iconpicker.prototype.removeAddClass = function (target, remove, add) {
      return (
        this.options.table.find(target).removeClass(remove).addClass(add), add
      );
    }),
    ...
    (Iconpicker.prototype.select = function (icon) {
      ...
      (op.selected = $.inArray(icon.replace(op.iconClassFix, ""), op.icons)),
        -1 === op.selected &&
          ((op.selected = 0), (icon = op.iconClassFix + op.icons[op.selected])),
        "" !== icon &&
          op.selected >= 0 &&
          ((op.icon = icon),
          op.inline === !1 &&
          ...
          if (0 === i || i === op.cols - 1) {
            var arrow = [
              '<button class="btn btn-arrow ' +
                ...
                '">',
              '<span class="' +
                (0 === i ? op.arrowPrevIconClass : op.arrowNextIconClass) +
                '"></span>',
              "</button>",
            ];
    ...
    $(document).on("click", "body", function (e) {
      $(".iconpicker").each(function () {
        $(this).is(e.target) ||
          ...
          $(this).popover("3.x" === $.fn.bsVersion() ? "destroy" : "dispose");
      });
    }),
