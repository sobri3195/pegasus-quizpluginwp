          ...
          exports["default"] = sweetAlert = swal = function () {
            ...
            switch (typeof customizations) {
              ...
              case "object":
                ...
                params.confirmButtonText = argumentOrDefault(
                  "confirmButtonText"
                );
      ...
      6: [
        function (require, module, exports) {
          ...
          var fixVerticalPosition = function fixVerticalPosition() {
            var $modal = getModal();
            $modal.style.marginTop = _removeClass$getTopMargin$fadeIn$show$addClass.getTopMargin(
              getModal()
            );
          };
        ...
        function (require, module, exports) {
          ...
          var setParameters = function setParameters(params) {
            ...
            if (params.cancelButtonText) {
              $cancelBtn.innerHTML = _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.escapeHtml(
                params.cancelButtonText
              );
            }
            if (params.confirmButtonText) {
              $confirmBtn.innerHTML = _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.escapeHtml(
