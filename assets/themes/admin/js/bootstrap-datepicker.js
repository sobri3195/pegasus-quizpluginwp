 ...
 *
 * Modifications to work with Bootstrap 3.x: http://kenyontechnology.com/2013/10/08/datepicker-for-bootstrap-with-twitter-bootstrap-3-0/
 *
 * ========================================================= */
...
(function ($) {
  ...
  var Datepicker = function (element, options) {
    ...
    this.component = this.element.is(".date")
      ? this.element.find(".input-group-addon, .btn")
      : false;
