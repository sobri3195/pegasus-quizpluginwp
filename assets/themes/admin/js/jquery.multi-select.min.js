  ...
  (MultiSelect.prototype = {
    ...
    init: function () {
      ...
      if (0 === ms.next(".ms-container").length) {
        ms.css({ position: "absolute", left: "-9999px" }),
          ms.attr(
            ...
            ms.attr("id")
              ? ms.attr("id")
              : Math.ceil(1e3 * Math.random()) + "multiselect"
          ),
      ...
      that.select(selectedValues, "init"),
        "function" == typeof that.options.afterInit &&
    ...
    generateLisFromOption: function (option, index, $container) {
      ...
      if ($optgroup.length > 0) {
        ...
        (index =
          void 0 == index ? that.$selectableUl.children().length : index),
        ...
        $.each(options, function (index, option) {
          if (
            ...
            var $option = $(
              ...
              index = parseInt(
                "undefined" == typeof option.index
                  ? that.$element.children().length
                  : option.index
              ),
              $container =
                void 0 == option.nested
                  ? that.$element
    ...
    activeKeyboard: function ($list) {
      ...
      $list
        ...
        .on("keydown", function (e) {
          switch (e.which) {
            ...
            case 38:
              return (
                e.preventDefault(),
                e.stopPropagation(),
                void that.moveHighlight($(this), 38 === e.which ? -1 : 1)
              );
            case 37:
            case 39:
              return (
          ...
          return $.inArray(e.which, that.options.keySelect) > -1
            ? (e.preventDefault(),
              e.stopPropagation(),
              void that.selectHighlighted($list))
            : void 0;
        });
    },
      ...
      if (($elems.removeClass("ms-hover"), 1 === direction)) {
        if (
          ...
          if ($optgroupUl.hasClass("ms-optgroup")) {
            ...
            $nextElem =
              $nextOptgroupLi.length > 0
                ? $nextOptgroupLi.find(this.elemsSelector).first()
                : $elems.first();
        ...
        if ($optgroupUl.hasClass("ms-optgroup")) {
          ...
          $nextElem =
            $prevOptgroupLi.length > 0
              ? $prevOptgroupLi.find(this.elemsSelector).last()
              : $elems.last();
      ...
      if (
        ...
        if (selectableOptgroups.length > 0) {
          ...
          selectionOptgroups.each(function () {
            ...
            selectionsLi.filter(".ms-selected").length > 0 &&
        ...
        "init" !== method &&
          (ms.trigger("change"),
          "function" == typeof that.options.afterSelect &&
    ...
    deselect: function (value) {
      ...
      if (selections.length > 0) {
        ...
        if (selectableOptgroups.length > 0) {
          selectableOptgroups.each(function () {
            var selectablesLi = $(this).find(".ms-elem-selectable");
            selectablesLi.filter(":not(.ms-selected)").length > 0 &&
              $(this).find(".ms-optgroup-label").show();
          });
          var selectionOptgroups = that.$selectionUl.children(
            ".ms-optgroup-container"
          ...
          selectionOptgroups.each(function () {
            var selectionsLi = $(this).find(".ms-elem-selection");
            0 === selectionsLi.filter(".ms-selected").length &&
              $(this).find(".ms-optgroup-label").hide();
          });
        }
        ms.trigger("change"),
          "function" == typeof that.options.afterDeselect &&
    ...
    deselect_all: function () {
      ...
      ms.find("option").prop("selected", !1),
        ...
        this.$selectableUl.focus(),
        ms.trigger("change"),
        "function" == typeof this.options.afterDeselect &&
    ...
    sanitize: function (value) {
      ...
      var ls = 0;
      for (i = 0, ls = value.length; ls > i; i++)
