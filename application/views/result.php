...
<div class="container">
  <div class="row"> 
    <div class="col-12 text-center">
      <h2 class="heading"><?php echo ucfirst($quiz_data->title); ?> <?php echo lang('quiz_summary'); ?></h2><hr>
    </div>
          ...
          <tbody>
            ...
            foreach ($user_question_data as  $question_data) 
            {
              ...
              <tr class="row100 body">
                <td class="cell100 result-column1"><?php echo sprintf("%02d", $l); ?>. <?php echo xss_clean($question_data['question']); ?>
                </td>
                ...
                <td class="cell100 result-column4">
                  ...
                  {
                    ?>
                    <a class="btn btn-success text-white btn-xs w-100" data-toggle="modal" data-target="#Modal_<?php echo xss_clean($question_data['id']); ?>"><?php echo lang('correct'); ?></a> 
                  <?php
                  }
                  elseif($question_data['is_correct'] == 0 && $given_answer_array)
                  {
                  ?>
                    <a class="btn btn-danger text-white btn-xs w-100" data-toggle="modal" data-target="#Modal_<?php echo xss_clean($question_data['id']); ?>"><?php echo lang('wrong'); ?></a>
                  <?php
                  }
                  else
                  {
                  ?>
                    <a class="btn btn-warning  text-white btn-xs w-100" data-toggle="modal" data-target="#Modal_<?php echo xss_clean($question_data['id']); ?>"><?php echo lang('not_attempted'); ?></a>
                  <?php
                  }
                  ?>
                </td>
