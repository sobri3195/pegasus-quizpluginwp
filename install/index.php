...
<html>
    <head>
        <title>Quizzy Installation Wizard</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="keywords" content="Quizzy Installation Wizard">
        ...
        <div class="main">
            ...
            <div class="main-agilerow"> 
                <div class="ci-install-wrap">
                    <h1><img src="images/logo.png" height="75" alt="Quizzy" /> </h1>

                    <span class="ci-subt">INSTALLATION WIZARD</span>
                    <hr />
                    <h2>Install Now</h2>
                    <p>Ajax Based Quick Installer </p>
                </div>	
                ...
                <div class="ci-form-wrap" id="success-wrap" style="display:none;">
                    ...
                    <p><a class="btn btn-primary" href="<?php echo $base_url; ?>/admin">Click Here</a><strong> to Login!</strong></p>
                ...
                <div class="ci-form-wrap" id="main-wrap">
                    <form action="#" method="post">
                        ...
                        <span class="hints" ><strong style="color: #dc3545;">*** Important:</strong> kindly remove the "install" directory from root once the installation completed.</span>
